...
public class InventoryController implements Serializable {
    ...
    @EJB private modelo.InventoryFacade ejbFacade;
    ...
    public static class InventoryControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Inventory) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+InventoryController.class.getName());
            }
        }
