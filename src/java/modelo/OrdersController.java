...
public class OrdersController implements Serializable {
    ...
    @EJB private modelo.OrdersFacade ejbFacade;
    ...
    public static class OrdersControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Orders) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+OrdersController.class.getName());
            }
        }
